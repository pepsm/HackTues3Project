...
string buttonText2("Stop");
string winName = "AirDraw";
Rect button, button2;
int flag = 0;
...
int main(int argc, char** argv) {
	...
	putText(canvas(button2), buttonText2,Point(button.width * 0.35, button.height * 0.7), FONT_HERSHEY_PLAIN,1, Scalar(0, 0, 0));
